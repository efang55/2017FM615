...
```
    ...
    /Users/michaelshen/anaconda3/lib/python3.6/site-packages/sklearn/cross_validation.py:41: DeprecationWarning: This module was deprecated in version 0.18 in favor of the model_selection module into which all the refactored classes and functions are moved. Also note that the interface of the new CV iterators are different from that of this module. This module will be removed in 0.20.
...
<img src="https://i.imgur.com/r6PRwR3.jpg"/>
...
```python
display(Image(url='https://i.imgur.com/jdjEJcM.jpg'))
```


<img src="https://i.imgur.com/jdjEJcM.jpg"/>
...
<img src="https://i.imgur.com/SDiLPM8.jpg"/>
...
```
    ...
    /Users/michaelshen/anaconda3/lib/python3.6/site-packages/ipykernel_launcher.py:1: DataConversionWarning: A column-vector y was passed when a 1d array was expected. Please change the shape of y to (n_samples,), for example using ravel().
...
```
    ...
    Index(['remaining', 'shot_id', 'angle_bin', 'game_year', 'season_start_year',
           'period', 'game_month', 'action_first_words_Jump', 'away',
           'action_first_words_Layup', 'combined_shot_type_Dunk',
           'action_first_words_Driving', 'combined_shot_type_Jump Shot',
           'action_first_words_Running', 'opponent_HOU', 'opponent_POR',
           'opponent_UTA', 'opponent_DEN', 'opponent_SAS', 'opponent_GSW',
           'opponent_SAC', 'opponent_DAL', 'opponent_MIN', 'opponent_LAC',
           'opponent_PHX', 'opponent_MEM', 'opponent_TOR', 'opponent_MIA',
           'opponent_ORL', 'opponent_NYK', 'opponent_SEA',
           'shot_zone_basic_Restricted Area', 'opponent_BOS', 'opponent_CHA',
           'distance_bin_0', 'opponent_CLE', 'opponent_PHI', 'opponent_IND',
           'opponent_DET', 'opponent_MIL', 'shot_type_3PT Field Goal',
           'action_first_words_Turnaround', 'opponent_CHI', 'distance_bin_2',
           'opponent_ATL', 'shot_zone_basic_In The Paint (Non-RA)', 'opponent_NJN',
           'opponent_NOH', 'opponent_OKC', 'opponent_WAS'],
          dtype='object')
