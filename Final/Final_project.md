...
display(Image('https://i.imgur.com/IykGbhG.jpg'))
```
...
```python
display(Image('https://i.imgur.com/r6PRwR3.jpg'))
```
...
```python
display(Image('https://i.imgur.com/jdjEJcM.jpg', width="400"))
```
...
```python
display(Image('https://i.imgur.com/SDiLPM8.jpg'))
```
